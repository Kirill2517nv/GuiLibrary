// Шрифт Roboto-Medium, вшитый в библиотеку.
//
// СГЕНЕРИРОВАННЫЙ ФАЙЛ – руками не править. Пересоздать:
//     cmake -S <проект с binary_to_compressed_c.cpp> -B build && cmake --build build
//     b2c -base85 external/imgui/misc/fonts/Roboto-Medium.ttf RobotoMedium > src/roboto_medium_font.cpp
//     (затем вернуть extern вместо static – см. ниже)
//
// Зачем вшивать, а не читать .ttf с диска: путь к системному шрифту у Windows,
// Linux и macOS разный, а в WebAssembly файловой системы нет вовсе. Вшитый
// массив – единственный способ, который работает на всех четырёх платформах
// одинаково. Roboto-Medium лежит в сабмодуле imgui (misc/fonts) и покрывает
// кириллицу, латиницу, знак градуса и короткое тире.
//
// extern, а не static: в C++ у const на уровне пространства имён внутренняя
// компоновка, и gui_library.cpp не увидел бы этот массив.

// File: 'external/imgui/misc/fonts/Roboto-Medium.ttf' (162588 bytes)
// Exported using binary_to_compressed_c.exe -base85 "external/imgui/misc/fonts/Roboto-Medium.ttf" RobotoMedium
extern const char RobotoMedium_compressed_data_base85[144680+1] =
